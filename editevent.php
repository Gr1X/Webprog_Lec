    ...
    <div class="form-container">
        ...
        <form action="inputeventproses.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" required name="nama_event" id="" placeholder="Event Name" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" required name="tanggal_event" id="event_date" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="time" required name="waktu_selesai" id="event_end_time" value="09:00">
            </div>
            <div class="form-group">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-create">Save Event</button>
            </div>
        </form>
